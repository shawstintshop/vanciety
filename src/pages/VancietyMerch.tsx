...
import {
  ShoppingBag, Star, Shirt, Coffee, Zap, Shield,
  ChevronRight, BadgeCheck, Truck, RotateCcw, ExternalLink,
} from "lucide-react";
...
const PRODUCTS = [
  ...
  {
    id: "snapback",
    name: "Vanciety Snapback",
    category: "Headwear",
    price: "$32",
    thumbnail: "https://images.unsplash.com/photo-1534215754734-18e55d13e346?w=600&q=80",
    colors: ["Black", "Olive"],
    sizes: ["One Size"],
    tag: null,
  },
  ...
  {
    id: "mug",
    name: "Vanciety Camp Mug",
    category: "Drinkware",
    price: "$24",
    thumbnail: "https://images.unsplash.com/photo-1572119865084-43c285814d63?w=600&q=80",
    colors: ["Matte Black"],
    sizes: ["11oz", "15oz"],
    tag: null,
  },
  ...
  {
    id: "sticker-pack",
    name: "Vanciety Sticker Pack",
    category: "Accessories",
    price: "$8",
    thumbnail: "https://images.unsplash.com/photo-1542621334-a254cf47733d?w=600&q=80",
    colors: ["Gold/Black"],
    sizes: ["5-pack"],
    tag: null,
  },
      ...
      <div className="max-w-6xl mx-auto px-4 pt-10 pb-4">
        ...
        >
          <div>
            ...
            <h2 className="text-2xl font-bold text-white mb-2">The Official Vanciety Store is Live</h2>
