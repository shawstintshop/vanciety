-- Update locations table to support all map section types
...
-- Add more diverse van life locations
...
('Van Life Insurance Specialists', 'Insurance agency specializing in converted van coverage.', 37.3382, -121.8863, 'business', ARRAY['insurance', 'van_conversion', 'advice', 'quotes']);

-- Add some sample user locations for testing (these would normally be real-time user data)
